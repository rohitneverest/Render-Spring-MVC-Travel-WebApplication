...
<section class="navbar-section">
    ...
    <div class="container">
        <h1>Tsomgo Lake & Nathula Pass - 2 Days</h1>
        <p>Experience the breathtaking beauty of Tsomgo Lake and the historic Nathula Pass, located at high altitudes in the Himalayas of Sikkim.</p>

        <div class="day">
            <h3>Day 1: Tsomgo Lake Exploration</h3>
            <p>Start your journey from Gangtok to Tsomgo Lake, a glacial lake situated at 12,400 ft. Enjoy the scenic beauty, ride on decorated yaks, and witness the changing colors of the lake.</p>
        </div>

        <div class="day">
            <h3>Day 2: Nathula Pass & Baba Mandir</h3>
            <p>Visit Nathula Pass, a historic Indo-China border pass at 14,140 ft. Later, explore Baba Harbhajan Singh Mandir, a revered shrine in the region, before returning to Gangtok.</p>
        </div>
    </div>
