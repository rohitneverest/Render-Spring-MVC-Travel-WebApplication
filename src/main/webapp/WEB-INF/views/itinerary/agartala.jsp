...
<section class="navbar-section">
    ...
    <div class="container">
        <h1>Agartala & Ujjayanta Palace - 2 Days</h1>
        <p>Discover the capital city of Tripura, Agartala, known for its royal heritage, beautiful temples, and serene lakes.</p>

        <div class="day">
            <h3>Day 1: Exploring Agartala</h3>
            <p>Arrive in Agartala and visit the Ujjayanta Palace, a grand royal residence with Mughal-inspired architecture. Explore Neermahal, a beautiful water palace located in the middle of Rudrasagar Lake.</p>
        </div>

        <div class="day">
            <h3>Day 2: Temples & Local Culture</h3>
            <p>Visit the historic Tripura Sundari Temple, one of the 51 Shakti Peethas. Later, explore local markets and experience the vibrant culture of Tripura before departure.</p>
        </div>
    </div>
