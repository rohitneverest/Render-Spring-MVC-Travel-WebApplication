...
<section class="navbar-section">
    ...
    <div class="container">
        <h1>Kohima & War Cemetery - 2 Days</h1>
        <p>Discover the rich history and scenic beauty of Kohima, the capital of Nagaland, and explore the famous War Cemetery dedicated to the soldiers of World War II.</p>

        <div class="day">
            <h3>Day 1: Arrival & Kohima Sightseeing</h3>
            <p>Arrive in Kohima and visit the Naga Heritage Village at Kisama. Explore the State Museum to learn about Naga tribes, followed by a stroll through the vibrant local markets.</p>
        </div>

        <div class="day">
            <h3>Day 2: Kohima War Cemetery & Local Attractions</h3>
            <p>Start the day with a visit to the Kohima War Cemetery, a peaceful and historic site honoring World War II soldiers. Later, explore the Cathedral of Kohima, offering breathtaking views of the city. Depart with memories of Nagaland's unique history and culture.</p>
        </div>
    </div>
